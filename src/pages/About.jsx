...
const About = () => {
  return (
    ...
    <div className="about-container">
      ...
      <h3>thinkingman.6019@gmail.com</h3>
      <div className="links">
        <a href="https://www.linkedin.com/in/ironstone-/"><img src={linkedin} alt="" /> Linkedln Profile</a>
        <a href="https://github.com/IRONSTONE-A"><img src={github} alt="" /> Github Page</a>    
      </div>
      <p>
